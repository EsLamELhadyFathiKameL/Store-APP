...
class _MyUpdateProductPageState extends State<MyUpdateProductPage> {
              ...
              children: [
                ...
                MyCustomButton(
                  ...
                  onTap: () async {
                    ...
                    setState(() {});
                    try {
                      await myUpdateProductMethod(myProduct);
  ...
  Future<void> myUpdateProductMethod(MyProductModeL myProduct) async {
    await MyUpdateProductService().myUpdateProductService(
